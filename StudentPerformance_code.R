...
# check if there is a difference of mean between male and female math score
...
#linearModel <- lm(gender ~ math.score+reading.score+writing.score, data = sp, family = binomial)
